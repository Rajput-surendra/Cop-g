                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              //                       return BorderSide(color: Theme.of(context).colorScheme.fontColor);
                              //                     }
                              //                     return BorderSide(color: Theme.of(context).colorScheme.fontColor.withOpacity(0.5));
                              //                   },
                              //                 ),
                              //                 contentPadding:
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          color: context.read<CartProvider>().selectedDate == index
              ? Theme.of(context).colorScheme.lightWhite : null,
