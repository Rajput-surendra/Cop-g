                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  ...
                  return  Center(
                    ...
                    child: CircularProgressIndicator(
                      strokeWidth: 4,
                      valueColor: AlwaysStoppedAnimation<Color>(Theme.of(context).colorScheme.fontColor),
                    ),
                  );
                }
              },
            ...
            child: Container(
              ...
              child: VideoProgressIndicator(
                ...
                colors: VideoProgressColors(
                  playedColor: Theme.of(context).colorScheme.fontColor,
                  backgroundColor: const Color(0x5515162B),
                  bufferedColor: Theme.of(context).colorScheme.fontColor.withOpacity(0.5),
                ),
