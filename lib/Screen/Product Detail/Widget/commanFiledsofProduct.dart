...
class SaveExtraWithOffers extends StatelessWidget {
  ...
  SaveExtraWithOffers({Key? key, required this.update, required this.product_ids, required this.product_price}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: InkWell(
        onTap: () async {
          Routes.navigateToPromoCodeScreen(context, 'Profile', update, product_ids, product_price);
        },
        child: ListTile(
          dense: true,
          title: Row(
