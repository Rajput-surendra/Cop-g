...
class ProductDetail extends StatefulWidget {
   ...
   ProductDetail(
      {Key? key, this.model, this.from3dProduct, this.secPos,  required this.index, this.list})
      : super(key: key);
...
class StateItem extends State<ProductDetail> with TickerProviderStateMixin {
  ...
  Future<void> promocodeAPI(String save) async {
    ...
    product_price.add(widget.model!.prVarientList![widget.model!.selVarient!].disPrice!);
    product_ids.add(widget.model!.id);
  ...
  Widget build(BuildContext context) {
    print('___1_______${widget.model}_________');
    print('____2______${widget.from3dProduct}_________');
    print('____3______${widget.secPos}_________');
    print('____4______${widget.index}_________');
    print('_____5_____${widget.list}_________');
        ...
        return InkWell(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      // color: widget.index! % 2 == 0 ? Color(0xff363638) : Color(0xff636366),
              ...
              Positioned(
                top: widget.from3dProduct == true? 40: 0,
                left: 0,
                right:widget.from3dProduct == true? 10: 0,
                child: AnimatedBuilder(
                  animation: AlwaysStoppedAnimation(0.5),
                  builder: (BuildContext context, Widget? child) {
                    return   Hero(
                      tag: 'tag1${widget.index}',
                      // child: CachedNetworkImage(imageUrl: sliderList[widget.index!]!, width: 350, ),
                      child: CachedNetworkImage(imageUrl: sliderList[0]!, width: 350, height: 350, fit: BoxFit.cover,),///changed_on 24 aug
                    );
                  },
    ...
    try {
      ...
      if (isNetworkAvail) {
        try {
          ...
          print("params_______________$parameter");
    ...
    try {
      ...
      if (isNetworkAvail) {
        try {
          ...
          print("remove_params_${parameter}");
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    //     ?
                                    // GetPrice(pos: selectIndex, from: true, model: widget.model)
                                    //     : GetPrice(pos: widget.model!.selVarient, from: false, model: widget.model,
                                    //       ),
                                    GetPrice(pos: selectIndex, from: true, model: widget.model),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: productList[index].isFavLoading!
                        ...
                        : Selector<FavoriteProvider, List<String?>>(
                            builder: (context, data, child) {
                              print("get_favourite_data____${data}");
                              return InkWell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Icon(
                                ...
                                onTap: () {
                                  print("CUR_USERID is $CUR_USERID ${!data.contains(productList[index].id)}");
                                  if (CUR_USERID != null) {
                                    !data.contains(productList[index].id)
                                        ? _setFav(index, from)
                    ...
                    () => setState(
                      () {
                        ...
                        if (mainlist.isNotEmpty) {
                          ...
                          print("productList_is________________${getdata['data']}");
