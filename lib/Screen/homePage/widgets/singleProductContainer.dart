                  ...
                  Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        double.parse(productDetails.prVarientList![0].disPrice!) != 0 && !showDiscountAtSameLine
                            ? Padding(
                                padding: const EdgeInsetsDirectional.only(
                                  start: 10.0,
                                  top: 5,
                              ...
                              child: Padding(
                                ...
                                child: Icon(
                                  !data.contains(productDetails.id)
                                      ...
                                      : Icons.favorite,
                                  size: 20,
                                  color:  !data.contains(productDetails.id) ? Theme.of(context).colorScheme.txtColor : Theme.of(context).colorScheme.redDark,
                                ),
                              ),
                              onTap: () {
                                if (CUR_USERID != null) {
