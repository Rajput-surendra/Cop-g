...
class OrderSummery extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for(int i=0; i<cartList.length; i++)
      total_price += (((double.parse(cartList[i].singleItemNetAmount!)) * double.parse(cartList[i].qty!)) + (((double.parse(cartList[i].singleItemTaxAmount!)) *
          double.parse(cartList[i].qty!))));
    print("total_price__________${total_price}");
