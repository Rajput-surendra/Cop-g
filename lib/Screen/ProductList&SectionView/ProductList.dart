                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon:  Padding(
                            ...
                            child: Icon(Icons.search,  color: Theme.of(context).colorScheme.fontColor,),
                          ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  const SizedBox(
                   ...
                   Text(' | ', style: TextStyle( color: Theme.of(context).colorScheme.fontColor,),),
                  GestureDetector(
                    onTap: filterDialog,
                    child: Row(
                      children: [
                              ...
                              if (index == 0) {
                                ...
                                for (int i = 0; i < att.length; i++) {
                                  ...
                                  choiceChip = ChoiceChip(
                                    ...
                                    selectedColor: Theme.of(context).colorScheme.fontColor,
                                    backgroundColor:
                                        Theme.of(context).colorScheme.white,
                                    shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: OutlinedButton(
                          ...
                          child: Text(
                            getTranslated(context, 'DISCARD')!, style: TextStyle( color: Theme.of(context).colorScheme.redDark),
                          ),
                        ),
                      ),
                      const Spacer(),
