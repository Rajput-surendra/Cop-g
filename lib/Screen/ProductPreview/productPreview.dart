                        ...
                        if (widget.videoType == 'youtube') {
                          ...
                          return SafeArea(
                            child: YoutubePlayer(
                              ...
                              liveUIColor: Theme.of(context).colorScheme.fontColor,
                            ),
                          );
                    ...
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: IconButton(
                              icon:  Icon(Icons.arrow_back_ios_outlined, color: Theme.of(context).colorScheme.fontColor),
                              onPressed: () {
                                setState(
                                  () {
                    ...
                    child: ClipRRect(
                      ...
                      child: BackdropFilter(
                        ...
                        child: Container(
                          ...
                          child: IconButton(
                            icon:  Icon(Icons.arrow_forward_ios_outlined,  color: Theme.of(context).colorScheme.fontColor),
                            onPressed: () {
                              setState(
                                () {
                                  _pageController!.animateToPage(
