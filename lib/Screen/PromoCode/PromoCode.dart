...
class PromoCode extends StatefulWidget {
  ...
  final List product_price;
  String? promo_code;

  PromoCode({Key? key, required this.from, required this.product_ids, required this.product_price, this.updateParent, this.promo_code})
      : super(key: key);
...
class StatePromoCode extends State<PromoCode> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    print("check_product_ids___________${widget.product_ids} and_price_________ ${widget.product_price }  and_code___  ${widget.promo_code}");


    Future.delayed(Duration.zero).then((value) => context.read<PromoCodeProvider>().getPromoCodes(isLoadingMore: false));
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return (index == value.promoCodeList.length &&
                              ...
                              :
                          value.promoCodeList[index].promoCode! == widget.promo_code && widget.promo_code != ""?
                          Padding(
                                              ...
                                              ? InkWell(
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        value.promoCodeList[index].promoCode ??
                                                            '',
                                                        style:  TextStyle(
                                                          fontWeight: FontWeight.bold,
                                                  ...
                                                  children: [
                                                    ...
                                                    SimBtn(
                                                      ...
                                                      onBtnSelected: () {
                                                        ...
                                                        for(int i=0; i<value.promoCodeList[index].products!.length; i++){
                                                          if(widget.product_ids.contains(value.promoCodeList[index].products![i].id)){
                                                          ...
                                                          print("checkkkkkkkkkkkkkkkk1${widget.product_ids.contains(value.promoCodeList[index].products![i].id)}");
                                                        }
                          ...
                          value.promoCodeList[index].promoCode! != widget.promo_code && widget.promo_code == null?
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 8.0),
                            child: Column(
                              children: [
                                      ...
                                      children: [
                                        ...
                                        SimBtn(
                                          ...
                                          onBtnSelected: () {
                                            ...
                                            //     );
                                            //   }
                                            //   print("checkkkkkkkkkkkkkkkk2${widget.product_ids.contains(value.promoCodeList[index].products![i].id)}");
                                            // }
