        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
                ...
                labelStyle: TextStyle(color: Theme.of(context).colorScheme.fontColor),
  ...
  Widget setForgotPasswordLabel(BuildContext context) {
    return Padding(
      ...
      child: Align(
        ...
        child: InkWell(
          child: Text(getTranslated(context, 'FORGOT_PASSWORD_LBL')!, style: TextStyle(color: Theme.of(context).colorScheme.fontColor,),),
          onTap: () {
