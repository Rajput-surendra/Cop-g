...
final Uri get_sub_catApi = Uri.parse('${baseUrl}get_sub_cat');
...
final Uri bid_place_orderApi = Uri.parse('${baseUrl}bid_place_order');
final Uri get_bid_ordersApi = Uri.parse('${baseUrl}get_bid_orders');
final Uri check_productsApi = Uri.parse('${baseUrl}check_products');
...
final Uri update_order_status = Uri.parse('${baseUrl}update_order_status');
final Uri paypalTransactionApi = Uri.parse('${baseUrl}get_paypal_link');
final Uri fetch_categoryApi = Uri.parse('${baseUrl}fetch_category');
final Uri fetch_brandsApi = Uri.parse('${baseUrl}fetch_brands');
final Uri fetch_taxApi = Uri.parse('${baseUrl}fetch_tax');
final Uri add_bid_productsApi = Uri.parse('${baseUrl}add_bid_products');
final Uri my_bid_productApi = Uri.parse('${baseUrl}my_bid_product');
final Uri get_legit_checkApi = Uri.parse('${baseUrl}get_legit_check');
final Uri my_product_biddingsApi = Uri.parse('${baseUrl}my_product_biddings');
final Uri my_biddingsApi = Uri.parse('${baseUrl}my_biddings');
final Uri bids_status_changeApi = Uri.parse('${baseUrl}bids_status_change');
final Uri all_bid_productApi = Uri.parse('${baseUrl}all_bid_product');
final Uri apply_bid_productsApi = Uri.parse('${baseUrl}apply_bid_products');
