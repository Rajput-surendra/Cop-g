...
class SectionModel {
  ...
  factory SectionModel.fromCart(Map<String, dynamic> parsedJson) {
    ...
    return SectionModel(
        ...
        perItemPrice: '0',
        productList: productList,
        singleItemNetAmount:parsedJson['net_amount']== null ? '0':parsedJson['net_amount'].toString(),
...
class Promo {
  ...
  factory Promo.fromJson(Map<String, dynamic> json) {
    List<PromProducts> productList = (json['products'] as List)
        .map((data) => PromProducts.fromJson(data))
        .toList();
...
class PromProducts {
  ...
  PromProducts({this.id, this.name, this.final_discount});

  PromProducts.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    final_discount = json['final_discount'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    data['name'] = this.name;
    data['final_discount'] = this.final_discount;
    return data;
  }
}
