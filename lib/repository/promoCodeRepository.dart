...
class PromoCodeRepository {
  ...
  static Future<Map<String, dynamic>> fetchPromoCodes({
    ...
    try {
      ...
      print("promoCodeList['promo_codes']11__________${promoCodeList['promo_codes']}");
      return {
        'totalPromoCodes': promoCodeList['total'].toString(),
        'promoCodeList': (promoCodeList['promo_codes'] as List).map((promoCodeData) => (Promo.fromJson(promoCodeData))).toList()
      };
